...
int  print_Ausage_A14()
{
	cout <<""
		"\n"
		"\tUsage: Xam2Soap  -InFile <in.bam>  -OutPut <Out.soap>\n"
		"\n"
		"\t\t-InFile    <str>   Input Sam/Bam Format file\n"
		"\t\t-OutPut    <str>   Output the SoapFormat file\n"
		"\n"
		"\t\t-QShift    <int>   SeqQ shift Trans:(-31/+31/0)[0]\n"
		"\t\t                   Sanger<->Illumina:! <-> @ \n"
		"\t\t-help              show this help\n" 
		"\n";
	return 1;
