...
int bamDepSliding_help01(int argc, char **argv , In3str1v * paraFA04 )
{
	...
	(paraFA04->List).push_back(NolyChr);
	(paraFA04->List).push_back(MaxY);
...
void DrawDepthSliding( string File , In3str1v * paraFA04 )
{
...
//int main(int argc, char *argv[])
{
	...
	if ((bamDepSliding_help01(argc, argv, paraFA04)==0))
	{
		delete paraFA04;
		return 0;
	}
	if	(!(paraFA04->TF2))
	{
		DrawDepthSliding(paraFA04->InStr1,  paraFA04 );
		delete paraFA04;
		return 1;
	}
	...
	DrawDepthSliding( GCDepth , paraFA04 );
